...
<p>Similar to Timeline JS, TimeMapper uses Google Sheets to publish interactive time maps, which situate individual events on a map.</p>
	...
	<p>My example map uses a map I published anonymously and embedded on this site. If you'd rather have a map published on TimeMapper's site, you can sign up for a free account using your Twitter account credentials. <a href="http://timemapper.okfnlabs.org/nickhomenda/super-bowls-since-2011">Here's the same map as above published to my TimeMapper account</a>.
</div><!-- /.blurb -->
