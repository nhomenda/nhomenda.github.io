...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- The following ____ templates are affecting the resulting opf file. -->
    <!-- This type of template is common in XSLT because it keeps ____ while removing ____. -->
    ...
    <!-- This type of template is also common in XSLT and is an easy way to ________. -->
    ...
    <!-- Lots of templates creating _______ from the source document. -->
    ...
    <!-- Among the below templates I add a couple classes: _____ and ______, so I need to remember to treat them in the CSS.-->
